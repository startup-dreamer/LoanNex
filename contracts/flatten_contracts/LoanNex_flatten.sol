...
contract LoanNexNFT is ERC721Enumerable {
    using Strings for uint256;

    uint256 public _tokenId = 0;
    address public deployer;
    address public LoanNex;
    bool private initialized;

    constructor() ERC721("LoanNex", "LNX") {
        deployer = msg.sender;
    }

    modifier onlyContract() {
        require(msg.sender == LoanNex, "Only LoanNex can call this function");
        _;
    }
    ...
    function setLoanNex(address LoanNex_) public onlyDeployer {
        LoanNex = LoanNex_;
        initialized = true;
    }
    ...
    function _beforeTokenTransfer(address from, address to, uint256 tokenId) internal {
        ILoanNex _loanNex = ILoanNex(LoanNex);
        uint256 _id = _loanNex.loansByNFt(tokenId);
        ILoanNex.LoanInfo memory loan = _loanNex.getLoansData(_id);
                ...
                Base64.encode(
                    bytes(
                        abi.encodePacked(
                            ...
                            tokenId.toString(),
                            '", "description":"',
                            "LoanNex NFT proof of ownership of loan on chain.",
                            '", "image": "',
